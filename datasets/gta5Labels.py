...
# This class is created to convert GTA5 labels in the same format of Cityscapes
...
class GTA5Labels_TaskCV2017(BaseGTALabels):
    ...
    def trans_id_to_rgb(self):
        id_to_rgb_map = {label.ID: label.color for label in self.list_}
